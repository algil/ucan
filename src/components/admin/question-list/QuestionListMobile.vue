<template>
  <v-list two-line>
    <template v-for="(question, index) in questions">
      <question-list-mobile-item :question="question" @onSelect="onSelect" :key="index"></question-list-mobile-item>
      <v-divider v-show="index !== questions.length - 1" :key="index"></v-divider>
    </template>
  </v-list>
</template>
