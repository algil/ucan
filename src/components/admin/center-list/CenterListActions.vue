...
<script>
  ...
  export default {
    ...
    mounted () {
      this.$events.on(EventTypes.CENTER_LIST_SELECTION_CHANGED, this.onSelectionChange);
    },

    beforeDestroy () {
      this.$events.off(EventTypes.CENTER_LIST_SELECTION_CHANGED, this.onSelectionChange);
    },
