...
<script>
  ...
  export default {
    ...
    mounted () {
      this.$events.on(EventTypes.QUESTION_CATEGORY_LIST_SELECTION_CHANGED, this.onSelectionChange);
    },

    beforeDestroy () {
      this.$events.off(EventTypes.QUESTION_CATEGORY_LIST_SELECTION_CHANGED, this.onSelectionChange);
    },
