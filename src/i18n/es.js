export default {
  ...
  label: {
    ...
    cost: 'Precio',
    delete: 'Eliminar',
    descriptionDog: 'Describe a tu mascota con 3 adjetivos',
    descriptionDogHint: 'Por ejemplo: Tranquilo, obediente, cariñoso',
    edit: 'Editar',
    email: 'Email',
    female: 'Hembra',
    gender: 'Sexo',
    ...
    previousTraining: '¿Adiestramiento previo?',
    receptionAge: 'Edad de adopción',
    receptionAgeHint: 'Por ejemplo: 3 meses',
    save: 'Guardar',
    size: 'Tamaño',
